      ...
      <div className="min-h-screen bg-[#121212] text-white font-sans relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full">
            {[...Array(20)].map((_, i) => (
              <div
                key={i}
                className="absolute bg-gold-400 rounded-full opacity-10 animate-float"
                style={{
        ...
        <header className="container mx-auto px-6 py-6 flex justify-between items-center relative z-10">
          ...
          <div className="hidden md:block">
            <Link href="https://tally.so/r/3qKJl7" target="_blank" rel="noopener noreferrer" className="bg-transparent text-white px-4 py-2 rounded-md text-sm md:text-base font-medium font-nunito border border-gold-600 hover:bg-gold-600 transition-colors duration-300">
              Fale conosco agora
            </Link>
          </div>
        ...
        <main className="pb-20 relative z-10">
          <section className="container mx-auto px-6 pt-20 pb-32">
            <div className="flex flex-col md:flex-row items-start justify-between">
              <div className="md:w-1/2 mb-16 md:mb-0 animate-fade-in-up">
              ...
              <div className="md:w-1/2 relative mt-12 md:mt-0 md:pl-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="bg-[#1E1E1E] p-4 rounded-lg mb-4 flex items-center max-w-md hover:scale-105 transition-transform duration-300">
                ...
                <div className="bg-[#1E1E1E] p-4 rounded-lg flex items-center max-w-md hover:scale-105 transition-transform duration-300">
                  <div className="bg-gold-600 p-2 rounded mr-4 flex-shrink-0">
            ...
            <div className="container mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={index} className="bg-[#252525] p-6 rounded-lg hover:scale-105 transition-transform duration-300">
                    <div className="bg-gold-600 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                      {item.icon}
                    </div>
          ...
          <section className="container mx-auto px-6 py-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
              {[
                ...
                <Link href={service.link} key={index} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center text-center p-6 rounded-lg transition-all duration-300 ease-in-out hover:bg-[#1E1E1E] hover:scale-105 active:scale-95">
            ...
            <div className="relative overflow-hidden">
              ...
              >
                {companies.map((company, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 w-full flex items-center justify-center p-4 bg-[#1E1E1E] rounded-lg hover:scale-105 transition-transform duration-300"
                  >
                    <Image 
                      src={company.logo} 
          ...
          <section className="container mx-auto px-6 py-24 mb-24" ref={testimonialsRef}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              {[
                ...
                <div key={index} className={`bg-[#1E1E1E] p-8 rounded-lg ${item.offset} transition-all duration-300 ease-in-out hover:scale-105`}>
          ...
          <section className="bg-[#1E1E1E] py-24" ref={contactRef}>
            <div className="container mx-auto px-6">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-0 font-montserrat md:w-1/2 text-center md:text-left animate-fade-in-up">
