    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-800 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
          Página não
          <span className="block text-transparent bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text" style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            encontrada.
          </span>
        </h2>
